...
export async function sendBanEmail(to: string, opts?: { name?: string }) {
  ...
  // Consistent spacing + symmetrical padding
  const outerPad = 24; // card padding
  const innerPad = 20; // body padding
          ...
          <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="width:600px;max-width:600px;">
            <tr>
              <td style="padding:0;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                  ...
                  <!-- Header (logo only, centered, clean) -->
                  <tr>
            ...
            <tr>
              <td style="padding:10px 10px 0 10px;font-size:11px;line-height:16px;color:#9ca3af;text-align:center;">
                This message was sent to ${safeTo}.
              </td>
            </tr>
