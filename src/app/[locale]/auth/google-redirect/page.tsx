// src/app/[locale]/auth/google-redirect/page.tsx
'use client';
...
export default function GoogleRedirectPage() {
  ...
  useEffect(() => {
    ...
    // Small delay so the session cookie is settled after the Google redirect
      ...
      <div className="min-h-screen flex flex-col items-center justify-center gap-3"
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100/80 px-10 py-8 flex flex-col items-center gap-4">
          ...
          <p className="text-sm font-semibold text-gray-600">
            {intl.formatMessage({ id: 'SignIn.signingIn' })}
          </p>
        </div>
      </div>
    </>
