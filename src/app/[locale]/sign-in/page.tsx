 ...
 const inputCls = (hasError: boolean) =>
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* ── RIGHT PANEL ── */}
      <div className="flex-1 flex flex-col items-center justify-center px-5 pt-16 pb-12 sm:px-10 bg-gradient-to-br from-slate-50 via-blue-50/20 to-white relative overflow-hidden">
