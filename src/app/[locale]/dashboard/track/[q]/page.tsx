...
export default function DashboardTrackDetailPage() {
  ...
  const invoiceStatusColor =
    invoiceStatus === "paid" ? "text-green-700 bg-green-50 dark:bg-green-500/10 border-green-200 dark:border-green-500/30"
    : invoiceStatus === "overdue" ? "text-red-700 bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-500/30"
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="p-5 sm:p-6">
              ...
              {(data.origin || data.statusNote || data.nextStep) && (
                <div className="mt-4 space-y-2 text-sm border-t border-gray-100 dark:border-white/10 pt-4">
                  {data.origin && (
                    ...
                    return (
                      <div key={`${ev.key || ev.label}-${idx}`} className="flex relative">
                        <div className="relative shrink-0 flex flex-col items-center" style={{ width: "14px" }}>
                          <div className="rounded-full border-[3px] border-white dark:border-gray-900 shadow-md flex items-center justify-center z-10 shrink-0"
                            ...
                            {(() => {
                              ...
                              const showCheck = (isCompleted && (!customBadgeText || badgeIsCompletion))
                                || (!customBadgeText && isDelivered) || badgeIsCompletion;
                        ...
                        <div className="flex-1 min-w-0 pb-4 ml-3">
                          <div className={`rounded-2xl border shadow-sm overflow-hidden transition ${
                            !customBadgeColor
                              ? isCompleted ? "border-green-200 dark:border-green-500/30 bg-green-50/40 dark:bg-green-500/5"
                                : isCurrent && isCancelled ? "border-red-200 dark:border-red-500/30 bg-red-50/40 dark:bg-red-500/5 shadow-md"
                                : isCurrent && isDelivered ? "border-green-200 dark:border-green-500/30 bg-green-50/40 dark:bg-green-500/5 shadow-md"
                                : isCurrent ? "border-blue-200 dark:border-blue-500/30 bg-blue-50/40 dark:bg-blue-500/5 shadow-md"
                            ...
                            <button type="button" onClick={() => setOpenIdx((cur) => (cur === idx ? null : idx))}
                              ...
                              <div className="flex items-start justify-between gap-3">
                                <div className="flex items-start gap-3 min-w-0">
                                  <div className={`shrink-0 h-10 w-10 rounded-xl flex items-center justify-center border ${
                                    !customBadgeColor
                                      ? isCompleted ? "bg-green-100 dark:bg-green-500/15 border-green-200 dark:border-green-500/30 text-green-700 dark:text-green-400"
                                        : isCurrent && isCancelled ? "bg-red-100 dark:bg-red-500/15 border-red-200 dark:border-red-500/30 text-red-700 dark:text-red-400"
                                        : isCurrent && isDelivered ? "bg-green-100 dark:bg-green-500/15 border-green-200 dark:border-green-500/30 text-green-700 dark:text-green-400"
                                        : isCurrent ? "bg-blue-100 dark:bg-blue-500/15 border-blue-200 dark:border-blue-500/30 text-blue-700 dark:text-blue-400"
                                      ...
                                      <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold border ${
                                        !customBadgeText
                                          ? isCompleted ? "bg-green-100 dark:bg-green-500/15 text-green-700 dark:text-green-400 border-green-200 dark:border-green-500/30"
                                            : isCurrent && isCancelled ? "bg-red-100 dark:bg-red-500/15 text-red-700 dark:text-red-400 border-red-200 dark:border-red-500/30"
                                            : isCurrent && isDelivered ? "bg-green-100 dark:bg-green-500/15 text-green-700 dark:text-green-400 border-green-200 dark:border-green-500/30"
                                            : isCurrent ? "bg-blue-100 dark:bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-500/30"
                                      ...
                                      return (
                                        <div key={`entry-${j}`} className="relative pl-1">
                                          ...
                                          <div className="absolute left-[-12px] top-[11px]">
                                            <div className="h-2.5 w-2.5 rounded-full ring-2 ring-white dark:ring-gray-900 shadow-sm" style={{ background: entryDotBg }} />
                                          </div>
