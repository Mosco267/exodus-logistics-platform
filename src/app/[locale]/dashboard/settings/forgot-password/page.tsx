  ...
  return (
    <div className="max-w-md mx-auto space-y-5 pb-10">
      <div className="flex items-center gap-3">
        <button onClick={() => step === 'email' ? router.push(`/${locale}/dashboard/settings/security`) : setStep(step === 'code' ? 'email' : 'code')}
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm p-6">
              ...
              {[0,1,2,3,4,5].map(i => (
                <input key={i} id={`reset-box-${i}`} type="text" inputMode="numeric" maxLength={1}
                  ...
                  onPaste={e => {
                    ...
                    const box = document.getElementById(`reset-box-${last}`); if (box) (box as HTMLInputElement).focus();
                  }}
        ...
        {step === 'done' && (
          <div className="text-center space-y-4 py-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Your password has been updated. You can now sign in with your new password.</p>
