...
import {
  ...
  Printer, FileText, Truck, CreditCard, ShieldCheck,
} from "lucide-react";
...
export default function DashboardInvoiceDetailPage() {
  ...
  // Payment method shouldn't say "Completed via X" unless status is paid
    ...
    <div className="max-w-4xl mx-auto pb-12 space-y-5">
      ...
      <div className="no-print flex flex-col sm:flex-row gap-2">
        ...
        <button onClick={printNow}
          className="cursor-pointer w-full sm:w-auto sm:ml-auto justify-center inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900 text-sm font-semibold text-gray-700 dark:text-gray-200 hover:opacity-90 transition shadow-sm">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="p-5 sm:p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                ...
                {/* Charges Breakdown — same style as admin create-shipment Preview */}
                <div className={card5}>
                  <div className="flex items-center gap-2 mb-3">
                    <FileText className="w-4 h-4" style={{ color: accentSolid }} />
