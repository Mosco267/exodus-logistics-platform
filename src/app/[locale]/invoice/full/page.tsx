...
export default function FullInvoicePage() {
  ...
  const q = useMemo(() => {
    return String(sp.get("q") || sp.get("tracking") || "").trim();
  }, [sp]);
  ...
  useEffect(() => {
    const run = async () => {
      ...
      try {
        const res = await fetch(`/api/invoice?q=${encodeURIComponent(q)}`, {
          cache: "no-store",
        });
  ...
  const trackingOrShipment =
    data.shipment.trackingNumber || data.shipment.shipmentId || q;
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-cyan-50 py-10">
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="no-print flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between mb-6">
          <Link
            href={`/${locale}/invoice?q=${encodeURIComponent(trackingOrShipment)}`}
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Invoice Summary</p>
                </div>
              </div>
          ...
          <div className="p-8">
            ...
            {/* Charges (simple for now: your invoice total) */}
            ...
            <div className="mt-8 text-xs text-gray-500">
              <p>
                This invoice was generated by Exodus Logistics. If you need assistance, please contact support.
              </p>
            </div>
          </div>
        </motion.div>
